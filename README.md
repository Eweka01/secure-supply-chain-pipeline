...
# {"version":"1.0.0","build_commit":"unknown","build_date":"unknown"}
```
...
- ECR repository (`supply-chain-app`) with immutable tags, scan on push, 10-image lifecycle policy
...
| ECR Repository | `supply-chain-app` | Immutable tags, scan on push |
